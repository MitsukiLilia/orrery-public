...
5. 浏览历史是检索的影子。一部分检索会带 1〜2 条「点进去的页面」(visits):标题像真实网页(Q&A、まとめ、攻略 wiki、商品页,以及日本网络特产的诊断/占い/恋愛コラム/「〜な人の特徴10選」式ランキング记事那一挂——心里有事的人深夜最容易点进相性診断),站名是这个世界里的网站、贴合世界观,不写现实世界的真实网站名;另一部分浏览是与心事无关的日常惯性(天气、新闻、兴趣、购物),让历史像真人的手机。
6. {{LANG_RULE}}
...
3. 像真实的网页。日本互联网的页面千姿百态:Q&A 的采纳答案与回答楼、まとめ的引用块配色、个人博客的碎碎念、企业页的规整、攻略 wiki 的表格、诊断/占い页的大字结果与煽り文句、「〜な人の特徴10選」式コラム的编号小标题与广告位感——按站名与标题判断这是哪一挂,用 HTML 加内联 <style> 自由还原它的排版气质。配色与排版可以大胆,网页的「土味」与「个性」本身就是趣味。
